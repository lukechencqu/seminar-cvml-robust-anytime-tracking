...
\begin{abstract}
  ...
  object classes, are still a problem. The proposed method uses a
  ...
  with similar runtime $25\%$ lower RMS tracking
  error than the baseline methods. Furthermore, the tracker is robust against occlusions,
