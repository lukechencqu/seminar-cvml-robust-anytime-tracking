...
possible sub-cells before and after dividing. Let distribution $B$ be
...
in~\cite{paper}. \textcolor{red}{Probably show this?}.
...
whether they are used as a measurement model in for Kalman
...
cars. Therefore, the data contains a variety of of different objects.
...
{\centering{\url{http://stanford.edu/~davheld/DavidHeld_files/RSS2014_Poster.pdf}}\\}
