...
matchings. This can be done by analyzing a dataset with already
known alignments. For an autonomous car such a dataset can be easily
...
a certain threshold (5cm was used by the authors of the paper). 
