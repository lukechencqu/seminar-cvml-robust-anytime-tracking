...
\begin{figure}
  \center
  \subfigure[Path taken by the car on the parking space]{%
    \includegraphics[height=.25\linewidth]{rel-ref-frame-path}
    \label{fig:rel-ref-frame-path}
  }
  \subfigure[Distribution of linear velocities\\ of tracked objects in the
    local refference\\ frame]{%
    \includegraphics[height=.25\linewidth]{rel-ref-frame-vel}
    \label{fig:rel-ref-frame-vel}
  }
  \subfigure[Distribution of rotational velocities\\ of tracked objects in the
    local refference\\ frame]{%
    \includegraphics[height=.25\linewidth]{rel-ref-frame-rot}
    \label{fig:rel-ref-frame-rot}
  }
  
  \caption{Movement of the recording path when generating tracking
    data for the local refference frame approach~\cite{paper}.}
